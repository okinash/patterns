...
class PHPEngineerFactory extends AbstractEngineerFactory
{
    ...
    private function createEngineer($level)
    {
        ...
        $className = __NAMESPACE__ . DIRECTORY_SEPARATOR . "Engineers" . DIRECTORY_SEPARATOR . "PHP" . DIRECTORY_SEPARATOR . $level . "Engineer";
        echo $level . " engineer Created\r\n";
